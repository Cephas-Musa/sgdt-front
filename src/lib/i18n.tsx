...
const dict = {
  fr: {
    ...
    "nav.verification": "Vérification & Contrôle",
    ...
    "theme.light": "Clair",
    "theme.dark": "Sombre",
    "otp.title": "Vérifiez votre numéro de téléphone",
    "otp.desc1": "Nous vous avons envoyé un SMS avec un code à 6 chiffres au numéro ci-dessus.",
    "otp.desc2": "Pour finaliser la vérification de votre numéro, veuillez entrer le code à 6 chiffres.",
    "otp.verify": "Vérifier le code",
    "otp.verifying": "Vérification…",
    "otp.noCode": "Vous n'avez pas reçu le code ?",
    "otp.resend": "Renvoyer",
    "otp.resendPlaceholder": "Fonctionnalité de renvoi à implémenter.",
    "otp.digitLabel": "Chiffre",
  ...
  en: {
    ...
    "otp.desc1": "We've sent you an SMS with a 6-digit code to the phone number above.",
    "otp.desc2": "To complete the verification of your phone number, please enter the 6-digit code.",
    "otp.verify": "Verify Code",
    "otp.verifying": "Verifying…",
    "otp.noCode": "Didn't receive the code?",
    "otp.resend": "Resend",
    "otp.resendPlaceholder": "Resend feature coming soon.",
