    ...
    return (
        <div>
            <div className="mb-6 flex items-center gap-4">
                ...
                <PageHeader
                    title={`Alerte ${alerte.id}`}
                    description={typeLabel[alerte.type]}
                />
            </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="rounded-lg border border-border bg-card p-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                <h3 className="font-medium mb-3 text-sm text-muted-foreground">Actions recommandées</h3>
                                        ...
                                        <>
                                            ...
                                            <div className="flex gap-3 p-3 rounded-md border border-border hover:bg-muted/50 cursor-pointer">
                                                ...
                                                <div className="text-sm">
                                                    ...
                                                    <p className="text-xs text-muted-foreground">Suspendre le traitement en attente d'enquête</p>
                                                </div>
                                            </div>
                                        </>
                                    )}
                                        ...
                                        <>
                                            <div className="flex gap-3 p-3 rounded-md border border-border hover:bg-muted/50 cursor-pointer">
                                                ...
                                                <div className="text-sm">
                                                    ...
                                                    <p className="text-xs text-muted-foreground">Envoyer un avis de paiement</p>
                                                </div>
                                            </div>
                                            <div className="flex gap-3 p-3 rounded-md border border-border hover:bg-muted/50 cursor-pointer">
                                                <div className="w-5 h-5 rounded-full border-2 border-border mt-0.5" />
                                                <div className="text-sm">
                                                    ...
                                                    <p className="text-xs text-muted-foreground">Empêcher la progression jusqu'au paiement</p>
                                                </div>
                                            </div>
                                        </>
                                    )}
                                        ...
                                        <>
                                            <div className="flex gap-3 p-3 rounded-md border border-border hover:bg-muted/50 cursor-pointer">
                                                ...
                                                <div className="text-sm">
                                                    ...
                                                    <p className="text-xs text-muted-foreground">Envoyer une notification urgente</p>
                                                </div>
                                            </div>
                                        </>
                                    )}
                                        ...
                                        <>
                                            <div className="flex gap-3 p-3 rounded-md border border-border hover:bg-muted/50 cursor-pointer">
                                                ...
                                                <div className="text-sm">
                                                    ...
                                                    <p className="text-xs text-muted-foreground">Envoyer une demande de rectification</p>
                                                </div>
                                            </div>
                                        </>
                                    )}
