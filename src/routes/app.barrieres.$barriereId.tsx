                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="font-medium">{entree.type === "véhicule" ? "Véhicule" : "Vrac"}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="lg:col-span-1 space-y-4">
                    ...
                    <div className="rounded-lg border border-border bg-card p-6">
                        ...
                        <div className="space-y-2">
                            <Button variant="outline" className="w-full">📝 Ajouter note</Button>
                            <Button variant="outline" className="w-full">✓ Valider</Button>
                            <Button variant="outline" className="w-full">❌ Bloquer</Button>
                        </div>
                    </div>
                </div>
            </div>
