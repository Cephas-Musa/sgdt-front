            ...
            <div className="grid gap-6 lg:grid-cols-3">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                ...
                                <div className="rounded-md border border-border p-3">
                                    ...
                                    <p className="font-bold text-lg">{Math.round(entrepot.capacite * utilisationPourcentage / 100)}</p>
                                    <p className="text-xs text-muted-foreground">unités</p>
                                </div>
                                <div className="rounded-md border border-border p-3">
                                    <p className="text-xs text-muted-foreground">Disponible</p>
                                    <p className="font-bold text-lg">{Math.round(entrepot.capacite * (100 - utilisationPourcentage) / 100)}</p>
                                    <p className="text-xs text-muted-foreground">unités</p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="lg:col-span-1 space-y-4">
                    <div className="rounded-lg border border-border bg-card p-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-2">
                                <span className={`h-2 w-2 rounded-full ${utilisationPourcentage > 80 ? "bg-destructive" : utilisationPourcentage > 60 ? "bg-warning" : "bg-green-500"}`} />
                    ...
                    <div className="rounded-lg border border-border bg-card p-6">
                        ...
                        <div className="space-y-2">
                            <Button variant="outline" size="sm" className="w-full">📋 Inventaire</Button>
                            <Button variant="outline" size="sm" className="w-full">📊 Rapports</Button>
                            <Button variant="outline" size="sm" className="w-full">⚙️ Paramètres</Button>
                        </div>
                    </div>
