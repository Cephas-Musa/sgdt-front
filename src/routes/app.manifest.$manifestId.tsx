    ...
    return (
        <div>
            <div className="mb-6 flex items-center gap-4">
                ...
                <PageHeader
                    title={`Manifest ${manifest.reference}`}
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                ...
                <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div className="font-bold text-lg">{canSeeAmount ? `USD ${manifest.montant}` : "Confidentiel"}</div>
                                </div>
                                <div>
                    ...
                    {/* Flux du traitement */}
                    <div className="rounded-lg border border-border bg-card p-6">
                        <h2 className="mb-4 font-semibold text-lg">Progression du manifest</h2>

                        <div className="space-y-2">
                            {["payé", "barrière 1", "barrière 2", "cachet", "sortie Ouganda"].map((status, i) => {
                                const isActive = ["payé", "barrière 1", "barrière 2", "cachet", "sortie Ouganda"].indexOf(manifest.status) >= i;
                                const isCompleted = ["payé", "barrière 1", "barrière 2", "cachet", "sortie Ouganda"].indexOf(manifest.status) > i;
                                const isCurrent = manifest.status === status;

                                return (
                                    <div key={status} className="flex gap-3">
                                        <div className="flex flex-col items-center">
                                            <div className={`h-3 w-3 rounded-full ${isCompleted ? "bg-green-500" : isActive ? "bg-blue-500" : "bg-muted"
                                                }`} />
                ...
                <div className="lg:col-span-1 space-y-4">
                    ...
                    <div className="rounded-lg border border-border bg-card p-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Button variant="outline" size="sm" className="w-full">✓ Valider étape</Button>
                            <Button variant="outline" size="sm" className="w-full">📝 Notes</Button>
                        </div>
                    </div>
                    ...
                    <div className="rounded-lg border border-border bg-card p-6">
                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-medium">{canSeeAmount ? `USD ${manifest.montant}` : "Confidentiel"}</span>
                            </div>
                            <div className="flex justify-between">
