...
function SecretariatPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Gestion Secrétariat"
        description={
          isInspecteur
            ? "Créez vos secrétaires et gérez leurs accès"
            : "Validation, paiement, apurement."
        }
      />
      ...
      {isInspecteur ? (
          ...
          <div className="rounded-lg border border-border bg-card">
              ...
              >
                ...
                <div className="mt-3">
                  <Button
                    ...
                    className="gap-1"
                    onClick={() => {
                      navigator.clipboard.writeText(`MDP: ${genPwd}`);
                      toast.info("Identifiants copiés ✓");
                    }}
                  >
            ...
            <div className="p-3">
              <div className="mb-3 flex items-center gap-2 rounded-md bg-accent/5 border border-accent/20 p-3 text-sm">
                ...
                <span>
                  Vous êtes le seul à créer et gérer vos secrétaires. Chacun vous est rattaché.
                </span>
              </div>
        ...
        <div className="rounded-lg border border-border bg-card p-4">
          <p className="text-sm text-muted-foreground">
            Fonctionnalités de secrétariat disponibles depuis le tableau de bord et les pages
            Dossiers / Apurement.
          </p>
        </div>
      )}
